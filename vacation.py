...
def best_vacation_spot(weather_type):
    ...
    # rain = New York
    # sun = Mexico
    vacation_spot = vacation_by_weather[weather_type]
...
def get_my_vacation():
    ...
    if season not in seasons:
        ...
        vacation_act = vacation_activity(weather)

        print "You should travel to {}, where you can spend your time {}!".format(vacation_spot, vacation_act)
